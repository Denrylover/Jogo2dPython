...
while True:
    if level.game_status == 'play':
        ...
        instrucoes3 = font.render('Aperte <- para mover para esquerda e -> para mover para direita', False,
                                  (255, 255, 255))
        ...
        fim1 = font.render('SUA ARMADURA JUNTOU-SE AO EXERCITO DE ESQUELETOS FORMADO POR AQUELES QUE OUTRORA FALHARAM.',
                           False, (255, 255, 255))
        ...
        texto1 = font.render('VOCE REUNIU AS MOEDAS PERDIDAS. AGORA VOCE E VISTO COMO UM HEROI!', False,
                             (255, 255, 255))
